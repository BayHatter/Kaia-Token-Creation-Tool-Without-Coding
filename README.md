# Kaia Mainnet Token Creation Tool

A simple frontend tool to create tokens on the Kaia Mainnet (KAIA) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Kaia-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Kaia Mainnet Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Kaia-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Kaia Mainnet wallet address for receiving fees. Also set fee in KAIA that you want to charge
